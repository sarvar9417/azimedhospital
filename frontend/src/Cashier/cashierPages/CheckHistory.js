        ...
        <div className="row" style={{ justifyContent: 'space-between' }}>
          <div className="col-sm-6 col-lg-4 input_box">
            ...
            <button
              ...
              style={{ backgroundColor: '#45D3D3', marginLeft: '5px' }}
            >
        ...
        <table className="w-100 mt-3">
          <thead>
            <tr style={{ borderBottom: '1px solid #999' }}>
              ...
              <th
                style={{ width: '30%', textAlign: 'center', padding: '10px 0' }}
              >
                Bo'limlar
              </th>
              <th
              ...
              <th
                style={{ width: '20%', textAlign: 'center', padding: '10px 0' }}
              >
                To'langan
              </th>
              <th
              ...
              sections.map((section, key) => {
                ...
                return (
                  <tr>
                    ...
                    <td
                      style={{ width: '30%', textAlign: '', padding: '10px 0' }}
                    >
