              ...
              <tbody>
                <tr>
                  <td>
                    <ul className="list-unstyled  text-start m-3">
                      ...
                      <li style={{ fontFamily: 'times' }}>
                        {' '}
                        <h5 style={{ textAlign: '', fontSize: '10pt' }}>
                          {' '}
                          {today}
                        </h5>{' '}
                      </li>
                  ...
                  <td className="text-end">
                    ...
                    />
                    <br />
                    <img width="140" className="me-3" src={qr && qr} alt="QR" />
                    <br />
                    <p className="pe-3 me-1" style={{ fontSize: '10pt' }}>
                      Bu yerni skanerlang
                    </p>
                  </td>
                </tr>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="invoice-from">
                ...
                <h6 style={{ fontSize: '20pt', fontFamily: 'times' }}>
                    ...
                    {services &&
                      services.map((service, index) => {
                        ...
                        service.payment === "to'lanmagan"
                          ? (unpaid = unpaid)
                          : (unpaid =
                              unpaid + (service.price - service.priceCashier))
                        k++
