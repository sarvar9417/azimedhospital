...
toast.configure()
export const ClientsCounterAgent = () => {
    ...
    //     try {
    //         const agent = counteragent.lastname + " " + counteragent.firstname + " " + counteragent.fathername
    //         const fetch = await request(`/api/section/counteragent/${agent}`, 'GET', null, {
    //             Authorization: `Bearer ${auth.token}`
    //         })
    ...
    //         notify(e)
    //     }
    // }, [request, auth, setSections, setAllSections, counteragent])
    ...
    //         clearError()
    //     }
    //     // if (AllSections.length === 0 && counteragent ) {
    //     //     getAllSections()
    //     // }
    ...
    return (
        <div className="container"  >
            <div className='row'>
                <h5 >Kontragent: {counteragent && counteragent.lastname + " " + counteragent.firstname}</h5>
            </div>
                    ...
                    <table id="" className="table-striped table-hover" style={{ borderBottom: "1px solid #aaa", marginBottom: "10px" }} >
                        <thead>
                            <tr>
                                ...
                                <th scope="" className=" text-center">Ulushi <FontAwesomeIcon icon={faSort} /></th>
                            </tr>
                        </thead>
                    </table>
                </div>
                ...
                <table id="reseptionReport" className=" table-hover"  >
                    <thead className="d-none ">
                        <tr>
                            ...
                            <th scope="" className="prices text-center">To'lov <FontAwesomeIcon icon={faSort} /></th>
                            <th scope="" className="prices text-center">To'langan <FontAwesomeIcon icon={faSort} /></th>
                            <th scope="" className="prices text-center">Ulushi <FontAwesomeIcon icon={faSort} /></th>
                        </tr>
                    </thead>
                    <tbody className="" >
                                ...
                                if (client._id === section.client) {
                                    ...
                                    return (
                                        <tr key={key} >
                                            ...
                                            <td > {counteragent && section.priceCashier * counteragent.procient / 100} </td>
                                        </tr>
                                    )
                                }
                            }))
                    ...
                    <tfooter className="d-none ">
                        <tr>
                            ...
                            <th scope="" className="prices text-center"> {counteragent && paid * counteragent.procient / 100} </th>
                        </tr>
                    </tfooter>
                                ...
                                if (client._id === section.client) {
                                    ...
                                    return (
                                        <tr key={key} >
                                            ...
                                            <td className="prices text-bold text-danger" >{counteragent && section.priceCashier * counteragent.procient / 100}</td>
                                        </tr>
                                    )
                                }
                            })
            ...
            <table className=" table-hover" style={{ minWidth: "1100px" }}  >
                <tfooter className=" ">
                    <tr className="mt-3">
                        ...
                        <th scope="" className="prices text-center text-danger"> {counteragent && paid * counteragent.procient / 100} </th>
                    </tr>
                </tfooter>
            </table>
        </div>
